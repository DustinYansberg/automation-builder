...
import { ContainerScroll } from "@/components/container-scroll-animations";
import { Button } from "@/components/ui/button";
import { clients, products } from "@/lib/constant";
import { InfiniteMovingCards } from "@/components/global/infinite-scrolling-cards";
...
export default function Home() {
  return (
    <main>
      ...
      >
        {/* <div
          className="max-w-4xl mx-auto p-4 relative z-10 flex items-center 
          ...
          <ContainerScroll
            titleComponent={
              <div className="flex items-center justify-center flex-col">
                <Button
                  size={"lg"}
                  className="p-8 mb-8 md:mb-0 text-2xl w-full sm:w-fit border-t-2 
                  rounded-full border-[#4D4D4D] bg-[#1F1F1F] hover:bg-white group 
