...
const Navbar = async (props: Props) => {
  return (
    <header
      className="fixed right-0 left-0 top-0 top-0 py-4 px-4 bg-black/40
      ...
      <aside className="flex items-center gap-4">
        <Link
          ...
          className="relative inline-flex h-10 overflow-hidden 
                    roudned-full p-[2px] focus:outline-none focus:ring-2 
                    focus:ring-slate-400 focus:ring-offset-2 
                    focus:ring-offset-slate-50"
        >
          <span
            className="absolute inset-[-1000%] animate-
          ...
          <span
            className="inline-flex h-full w-full cursor-pointer
                        items-center jsutify-center rounded-full bg-slate-950 px-3
